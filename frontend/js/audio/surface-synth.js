...
export class SurfaceSynth {
  constructor(context) {
    ...
    this.grassLowpass = createFilter(
      context,
      "lowpass",
      AUDIO_TUNING.surface.grassCutoff,
      0.7,
    );
    this.grassGain = createGain(context, 0);

    this.waterSource = createNoiseSource(context);
    this.waterLowpass = createFilter(
      context,
      "lowpass",
      AUDIO_TUNING.surface.waterCutoff,
      0.7,
    );
    ...
    this.flutterDepth = createGain(
      context,
      AUDIO_TUNING.surface.waterFlutterDepth,
    );
